...
class Dizhi extends React.Component {
    ...
    componentDidMount() {
        window.onload = function () {
            ...
            var dianhua = document.querySelector('.dianhua');
            var dizhi = document.querySelector('.dizhi');
            var youxiang = document.querySelector('.youxiang');
            ...
            xingming.innerHTML = localStorage.name;
            dianhua.innerHTML = localStorage.phone;
            dizhi.innerHTML = localStorage.address;
            youxiang.innerHTML = localStorage.email;
            ...
            province.onchange = function () {
                ...
                var cityarr = provinceList[index].cityList;
                city.innerHTML = "<option>请选择城市</option>"
                cityarr.forEach(function (v) {
                    var newoption = document.createElement("option");
                    newoption.text = v.name;
            ...
            city.onchange = function () {
                ...
                var areaarr = provinceList[index].cityList[cityindex].areaList;
                area.innerHTML = "<option>请选择地区</option>"
                areaarr.forEach(function (v) {
                    var newoption = document.createElement("option")
                    newoption.text = v;
        ...
        var provinceList = [
            ...
            },
            {
                ...
                {
                    name: '广州市',
                    areaList: ['东山区', '荔湾区', '越秀区', '海珠区', '天河区', '芳村区', '白云区', '黄埔区', '番禺区', '花都区', '增城市', '从化市']
                },
            ...
            },
            {
                ...
                {
                    name: '香港特别行政区',
                    areaList: ["中西区", "东区", "九龙城区", "观塘区", "南区", "深水埗区", "湾仔区", "黄大仙区", "油尖旺区", "离岛区", "葵青区", "北区", "西贡区", "沙田区", "屯门区", "大埔区", "荃湾区", "元朗区"]
                }
            ]
            },
            {
