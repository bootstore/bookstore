        ...
        window.onload=function () {
            ...
            save.onclick=function(){
                if(name1.value===""){
                    ...
                    window.location.pathname='/add11';
                }

                // var arr1;
                // if(localStorage.addlist){
                //     arr1= JSON.parse(localStorage.addlist);
                // }else {
                //     arr1 = [];
                // }
                // var aa={
                ...
                // };
                // arr1.push(aa);
                // localStorage.addlist=JSON.stringify(arr1);
                // console.log(arr1);
                var arr1=[{name1:name1.value,name2:phone.value,name3:email.value,name4:address.value}];
